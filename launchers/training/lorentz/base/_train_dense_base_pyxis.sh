#!/bin/bash
# =============================================================================
# Base Training Script: Lorentz Dense GPT (HELM-D) - Pyxis/Enroot
# =============================================================================
...
if [ -n "$MODEL_ARGS_STR" ]; then
    ALL_ARGS="${MODEL_ARGS_STR} ${HYPERBOLIC_ARGS_STR} ${TRAINING_ARGS[*]}"
else
    ALL_ARGS="${MODEL_ARGS[*]} ${HYPERBOLIC_ARGS[*]} ${TRAINING_ARGS[*]}"
fi
...
echo "Starting Lorentz Dense training via Pyxis..."
