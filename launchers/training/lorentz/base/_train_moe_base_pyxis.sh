#!/bin/bash
# =============================================================================
# Base Training Script: Lorentz MoE GPT (HELM-MiCE) - Pyxis/Enroot
# =============================================================================
...
#   HYPERBOLIC_ARGS / HYPERBOLIC_ARGS_STR - Hyperbolic geometry arguments
...
#
# Supports both array and _STR variable formats.
# =============================================================================
...
# Use Slurm environment variables if available (works in both salloc and sbatch)
...
# Build container flags: prefer --container-name if set, else --container-image
...
# DATA_BLEND_PATH: container-internal path to blend file (multi-source training)
# DATA_PATH: container-internal path to single dataset prefix
...
# Support both array and _STR variable formats
...
echo "Starting Lorentz MoE training via Pyxis..."
